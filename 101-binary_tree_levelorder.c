...
/**
 * print - helps in printing values from left to right
 ...
 */
void print(size_t level, const binary_tree_t *tree, void (*func)(int))
{
	if (level == 1)
		func(tree->n);
	else
	{
		print(level - 1, tree->left, func);
		print(level - 1, tree->right, func);
	}
}
